...
@Component({
    selector: 'app-owner-warning-light-detail',
    templateUrl: './owner-warning-light-detail.component.html',
    styleUrls: ['./owner-warning-light-detail.component.scss']
})
export class OwnerWarningLightDetailComponent implements OnInit {
    ...
    ngOnInit(): void {
        var partName: string = window.location.pathname;

        this.content = this.listLink.items.find((obj:any)=>{
            return obj.link.value === partName
        })
        if(this.content == {} || !this.content){
            this.content = {
                title: 'Rất tiếc, trang này không tồn tại!',
            }
        }
