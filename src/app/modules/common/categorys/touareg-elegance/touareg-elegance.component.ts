...
@Component({
    selector: 'app-touareg-elegance',
    templateUrl: './touareg-elegance.component.html',
    styleUrls: ['./touareg-elegance.component.scss']
})
export class TouaregEleganceComponent implements OnInit {
    ...
    content: any = [
        ...
        },
        {
            ...
            title: "Touareg Elegance (22KDN/000284)"
        },
        {
