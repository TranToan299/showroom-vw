...
@Component({
    ...
    styleUrls: ['./touareg.component.scss']
})


export class TouaregComponent implements OnInit {
    ...
    ) { this.titleService.setTitle(`${PAGE_TITLE.touareg} | Volkswagen Việt Nam`);  }
    device: string = "pc";

    @Input() isDeposit: boolean = false

    touaregBanner : string = "../../../../../assets/images/touareg/1.jpg"
    ...
    changeWidth() {
        ...
        if (w <= 576) {
            if (this.device != "mobile") {
                this.touaregBanner = '../../../../../assets/images/touareg/1.jpg';
            }
            this.device = "mobile";
        }
        else if (w <= 820) {
    ...
    ngOnInit(): void {
        ...
        this.commonService.getCategoryById(4).subscribe((data: any) => {
            console.log(data)
            this.meta.updateTag({ name: 'description', content: PAGE_META_DESCRIPTION.touareg });
    ...
    summaryElegance : any = {
        ...
        title:"Touareg Elegance",
        content: [
            {
                title: 'Giá từ',
                value: '2,999,000,000 VNĐ'
            },
            {
    ...
    content: any = [
        ...
        },
        {
            ...
            content: [
                ...
                {
                    title: 'Tiêu thụ nhiên liệu kết hợp (Elegance/Luxury)',
                    value: '10,20 / 10,08',
                    extraText:'lit/100km'
                },
                {
                    title: 'Tiêu thụ nhiên liệu trong đô thị (Elegance/Luxury)',
                    value: '13,31 / 13,33',
                    extraText:'lit/100km'
                },
                {
                    title: 'Tiêu thụ nhiên liệu ngoài đô thị (Elegance/Luxury)',
                    value: '8,41 / 8,24',
                    extraText:'lit/100km'
                }
            ]
        },
        {
            ...
            name: "Tải Brochure",
            link: 'https://www.fshare.vn/file/MF1JCSR67AKQ'
        },
        {
        ...
        },
        {
            ...
            images: [
                ...
                {type:'img', url:'../../../../../assets/images/touareg/2.jpg'},
                {type:'img', url:'../../../../../assets/images/touareg/3.jpg'}
            ],
            infos: [
                {
            ...
            content: [
                {
                    ...
                    image: ['../../../../../assets/images/touareg/4.jpg'],
        ...
        },
        {
            ...
            title: "",
            content: [
                '../../../../../assets/images/touareg/5.jpg',
                '../../../../../assets/images/touareg/6.jpg',
                '../../../../../assets/images/touareg/7.jpg'
            ],
            mt: '100px'
        },
        {
            ...
            content: [
                ...
                },
                {
                    ...
                    image: ['../../../../../assets/images/touareg/12.jpg'],
                ...
                },
                {
                    ...
                    image: ['../../../../../assets/images/touareg/11.jpg'],
                    listItem:[
                        {
                            list: [
