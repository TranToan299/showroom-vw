...
@Component({
  selector: 'app-prebooking-demo2',
  templateUrl: './prebooking-demo-2.component.html',
  styleUrls: ['./prebooking-demo-2.component.scss'],
})
export class PrebookingDemo2Component implements OnInit {
  constructor(
